...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'project_1_group_2.urdf'
    xacro_file = "project_1_group_2.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "project_1_group_2"
    use_urdf = False
    ...
    # Base Name or robot
    robot_base_name = "project_1_group_2"
    ####### DATA INPUT END ##########
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("project_1_group_2"), "rviz", "display_default.rviz"]
    )
